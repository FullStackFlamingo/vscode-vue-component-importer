...
module.exports = editor => {
  ...
  if (!wordRange) throw new Error(`Couldn't find component tag on cursor.`);
  let componentName = editor.document.getText(wordRange);
  componentName = ChangeCase.pascal(componentName);
